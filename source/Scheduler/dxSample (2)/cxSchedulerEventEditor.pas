...
{           ExpressScheduler                                         }
{                                                                    }
{           Copyright (c) 2003-2016 Developer Express Inc.           }
{           ALL RIGHTS RESERVED                                      }
{                                                                    }
...
{$ENDIF}
  ...
  dxLayoutControlAdapters, dxLayoutcxEditAdapters, dxSkinsCore,
...
type
  ...
  TcxSchedulerCustomEditorForm = class(TForm, IcxShedulerCustomEditorForm)
  private
...
procedure TcxSchedulerCustomEventEditor.WMNCActivate(var Message: TWMNCActivate);
begin
  if (dxApplicationActivateWindowHelper = nil) or
    not dxApplicationActivateWindowHelper.NormalizeTopMostWindows(Message, Self) then
    inherited;
end;
...
begin
  ...
  if cxShowRecurrenceEditor(Event, Helper.LookAndFeel, AModified,
    ReadOnly, Helper.NeedCheckLossOfExceptions, True) then
  begin
