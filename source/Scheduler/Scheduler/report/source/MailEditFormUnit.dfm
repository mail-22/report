inherited MailEditForm: TMailEditForm
  Left = 459
  Top = 317
  Caption = 'MailEditForm'
  PixelsPerInch = 96
  TextHeight = 17
  object pnlMain: TPanel [0]
    ...
    object mmo1: TMemo
      ...
      Alignment = taCenter
      Lines.Strings = (
        #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077' '#1080#1085#1092#1086#1088#1084#1072#1094#1080#1080' '#1087#1086' '#1088#1072#1073#1086#1090#1077' '#1089' '#1087#1080#1089#1100#1084#1072#1084#1080)
      TabOrder = 1
    end
