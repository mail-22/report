...
begin
  ...
  FileNamePathUniq := BDDirPathName + {'/' +} UniqueName;
   ...
   begin
      ...
      //DSAMessageDlg(2 , 'нет файла: ' +FileNamePathUniq + #13#10 + '', mtInformation, [], 0, dckScreen, 3);
      //DSAMessageDlg(jvdsdlg1.DialogID , 'нет файла: ' +FileNamePathUniq + #13#10 + '', mtInformation, [], 0, dckScreen, 3);
      ShowMessage3(FileNamePathUniq, 'нет файла');
      Exit;
   end
   else
   begin
