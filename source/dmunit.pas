...
type
  TDM = class(TDataModule)
    ...
    tblReportFiltr2type_task_i: TStringField;
    tblReportFiltr2type_task_str: TStringField;
    tblReportFiltr2basis_N: TStringField;
    tblReportFiltr2costofwork_F: TFloatField;
    tblReportFiltr2dog_Primech: TStringField;
    tblReportFiltr2emty: TStringField;
    tblReportFiltr2mail_Num_In: TStringField;
    tblReportFiltr2mail_Correspondent: TStringField;
    tblReportFiltr2mail_Data_In: TDateTimeField;
    tblReportFiltr2mail_Soderganie: TStringField;
    tblReportFiltr2mail_F: TIntegerField;
    tblReportFiltr2mail_Ispolnitel: TStringField;
    tblReportFiltr2mail_Resoluzia: TStringField;
    tblReportFiltr2nir_zayvka: TStringField;
    tblReportFiltr2nir_zayvka_file: TIntegerField;
    tblReportFiltr2nir_zayvka_otpravleno: TDateTimeField;
    tblReportFiltr2nir_plan: TStringField;
    tblReportFiltr2nir_teh_zad: TStringField;
    tblReportFiltr2nir_tz: TIntegerField;
    tblReportFiltr2nir_etap_srok: TDateTimeField;
    tblReportFiltr2nir_otchet: TIntegerField;
    tblReportFiltr2nir_act: TIntegerField;
    tblReportFiltr2nir_vnedrenie: TIntegerField;
    tblReportFiltr2dog_Zakazchik: TStringField;
